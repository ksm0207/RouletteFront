...
Winwheel.prototype.drawSegments = function () {
  if (this.ctx && this.segments)
    for (
      var a = this.centerX * this.scaleFactor, c = this.centerY * this.scaleFactor, b = this.innerRadius * this.scaleFactor, d = this.outerRadius * this.scaleFactor, e = 1;
      e <= this.numSegments;
      e++
    ) {
      ...
      if ((this.ctx.strokeStyle = r) || h) {
        ...
        this.innerRadius
          ? this.ctx.arc(a, c, b, this.degToRad(t.endAngle + this.rotationAngle - 90), this.degToRad(t.startAngle + this.rotationAngle - 90), !0)
          : this.ctx.lineTo(a, c);
        h && this.ctx.fill();
        r && this.ctx.stroke();
      }
...
function winwheelTriggerSound() {
  ...
  var c =
    'pin' == winwheelToDrawDuringAnimation.animation.soundTrigger ? winwheelToDrawDuringAnimation.getCurrentPinNumber() : winwheelToDrawDuringAnimation.getIndicatedSegmentNumber();
...
function winwheelStopAnimation(a) {
  0 != a &&
    ((a = winwheelToDrawDuringAnimation.animation.callbackFinished), null != a && ('function' === typeof a ? a(winwheelToDrawDuringAnimation.getIndicatedSegment()) : eval(a)));
}
